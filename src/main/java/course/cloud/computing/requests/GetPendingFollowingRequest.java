...
public class GetPendingFollowingRequest implements WorkItem {

	boolean isProcessed = false;
	int userId = 0;
	Users response = null;
	public GetPendingFollowingRequest(int id)
	{
		userId = id;
	}
	...
	public boolean process() {
		response = new Users();
		try {
			response = SocialNetworkDataBase.getPendingFollowing(userId);
